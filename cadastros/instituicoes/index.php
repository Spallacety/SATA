...
<?php foreach ($instituicoes as $instituicao) : ?>
	<tr>
		...
		<td class="row vallign right-align">
			...
			<a href="#!" onClick="abrirModalApagarInstituicao();" class="btn-flat red-text tooltipped deleteButton" data-position="bottom" data-delay="50" data-tooltip="Apagar" data-id="<?php echo $instituicao['id']; ?>"><i class="material-icons">delete</i></a>
		</td>
	</tr>
<?php endforeach; ?>
<?php else : ?>
