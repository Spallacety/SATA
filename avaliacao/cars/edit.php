...
<h4 class="main-text center">Editar CARS</p></h4>

<form action = "edit.php?id=<?php echo $resultado['id']; ?>" method = "post">
  ...
  <div id="q4div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q4" type="radio" id="q4-1" value="1" <?php echo ($resultado['q4'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q4" type="radio" id="q4-i1" value="1.5" <?php echo ($resultado['q4'] == '1.5')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q4" type="radio" id="q4-3" value="3" <?php echo ($resultado['q4'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q4" type="radio" id="q4-i3" value="3.5" <?php echo ($resultado['q4'] == '3.5')?'checked':'' ?> />
      <label for="q4-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q4" type="radio" id="q4-4" value="4" <?php echo ($resultado['q4'] == '4')?'checked':'' ?> />
  ...
  <div id="q5div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q5" type="radio" id="q5-1" value="1" <?php echo ($resultado['q5'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q5" type="radio" id="q5-i1" value="1.5" <?php echo ($resultado['q5'] == '1.5')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q5" type="radio" id="q5-3" value="3" <?php echo ($resultado['q5'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q5" type="radio" id="q5-i3" value="3.5" <?php echo ($resultado['q5'] == '3.5')?'checked':'' ?> />
  ...
  <div id="q6div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-1" value="1" <?php echo ($resultado['q6'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-i1" value="1.5" <?php echo ($resultado['q6'] == '1.5')?'checked':'' ?> />
      <label for="q6-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-2" value="2" <?php echo ($resultado['q6'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-i2" value="2.5" <?php echo ($resultado['q6'] == '2.5')?'checked':'' ?> />
      <label for="q6-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-3" value="3" <?php echo ($resultado['q6'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-i3" value="3.5" <?php echo ($resultado['q6'] == '3.5')?'checked':'' ?> />
      <label for="q6-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q6" type="radio" id="q6-4" value="4" <?php echo ($resultado['q6'] == '4')?'checked':'' ?> />
  ...
  <div id="q7div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-1" value="1" <?php echo ($resultado['q7'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-i1" value="1.5" <?php echo ($resultado['q7'] == '1.5')?'checked':'' ?> />
      <label for="q7-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-2" value="2" <?php echo ($resultado['q7'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-i2" value="2.5" <?php echo ($resultado['q7'] == '2.5')?'checked':'' ?> />
      <label for="q7-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-3" value="3" <?php echo ($resultado['q7'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-i3" value="3.5" <?php echo ($resultado['q7'] == '3.5')?'checked':'' ?> />
      <label for="q7-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q7" type="radio" id="q7-4" value="4" <?php echo ($resultado['q7'] == '4')?'checked':'' ?> />
  ...
  <div id="q8div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-1" value="1" <?php echo ($resultado['q8'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-i1" value="1.5" <?php echo ($resultado['q8'] == '1.5')?'checked':'' ?> />
      <label for="q8-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-2" value="2" <?php echo ($resultado['q8'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-i2" value="2.5" <?php echo ($resultado['q8'] == '2.5')?'checked':'' ?> />
      <label for="q8-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-3" value="3" <?php echo ($resultado['q8'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-i3" value="3.5" <?php echo ($resultado['q8'] == '3.5')?'checked':'' ?> />
      <label for="q8-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q8" type="radio" id="q8-4" value="4" <?php echo ($resultado['q8'] == '4')?'checked':'' ?> />
  ...
  <div id="q9div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-1" value="1" <?php echo ($resultado['q9'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-i1" value="1.5" <?php echo ($resultado['q9'] == '1.5')?'checked':'' ?> />
      <label for="q9-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-2" value="2" <?php echo ($resultado['q9'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-i2" value="2.5" <?php echo ($resultado['q9'] == '2.5')?'checked':'' ?> />
      <label for="q9-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-3" value="3" <?php echo ($resultado['q9'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-i3" value="3.5" <?php echo ($resultado['q9'] == '3.5')?'checked':'' ?> />
      <label for="q9-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q9" type="radio" id="q9-4" value="4" <?php echo ($resultado['q9'] == '4')?'checked':'' ?> />
  ...
  <div id="q10div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-1" value="1" <?php echo ($resultado['q10'] == '1')?'checked':'' ?> required/>
      <label for="q10-1" class="black-text">O comportamento é apropriado a situação e a idade da criança.</label>
    </p>
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-i1" value="1.5" <?php echo ($resultado['q10'] == '1.5')?'checked':'' ?> />
      <label for="q10-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-2" value="2" <?php echo ($resultado['q10'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-i2" value="2.5" <?php echo ($resultado['q10'] == '2.5')?'checked':'' ?> />
      <label for="q10-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-3" value="3" <?php echo ($resultado['q10'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-i3" value="3.5" <?php echo ($resultado['q10'] == '3.5')?'checked':'' ?> />
      <label for="q10-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q10" type="radio" id="q10-4" value="4" <?php echo ($resultado['q10'] == '4')?'checked':'' ?> />
  ...
  <div id="q11div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-1" value="1" <?php echo ($resultado['q11'] == '1')?'checked':'' ?> required/>
      <label for="q11-1" class="black-text">A comunicação verbal é apropriada a situação e a idade da criança.</label>
    </p>
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-i1" value="1.5" <?php echo ($resultado['q11'] == '1.5')?'checked':'' ?> />
      <label for="q11-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-2" value="2" <?php echo ($resultado['q11'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-i2" value="2.5" <?php echo ($resultado['q11'] == '2.5')?'checked':'' ?> />
      <label for="q11-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-3" value="3" <?php echo ($resultado['q11'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-i3" value="3.5" <?php echo ($resultado['q11'] == '3.5')?'checked':'' ?> />
      <label for="q11-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q11" type="radio" id="q11-4" value="4" <?php echo ($resultado['q11'] == '4')?'checked':'' ?> />
  ...
  <div id="q12div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-1" value="1" <?php echo ($resultado['q12'] == '1')?'checked':'' ?> required/>
      <label for="q12-1" class="black-text">A comunicação não-verbal é apropriada a situação e a idade da criança.</label>
    </p>
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-i1" value="1.5" <?php echo ($resultado['q12'] == '1.5')?'checked':'' ?> />
      <label for="q12-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-2" value="2" <?php echo ($resultado['q12'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-i2" value="2.5" <?php echo ($resultado['q12'] == '2.5')?'checked':'' ?> />
      <label for="q12-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-3" value="3" <?php echo ($resultado['q12'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-i3" value="3.5" <?php echo ($resultado['q12'] == '3.5')?'checked':'' ?> />
      <label for="q12-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q12" type="radio" id="q12-4" value="4" <?php echo ($resultado['q12'] == '4')?'checked':'' ?> />
  ...
  <div id="q13div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-1" value="1" <?php echo ($resultado['q13'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-i1" value="1.5" <?php echo ($resultado['q13'] == '1.5')?'checked':'' ?> />
      <label for="q13-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-2" value="2" <?php echo ($resultado['q13'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-i2" value="2.5" <?php echo ($resultado['q13'] == '2.5')?'checked':'' ?> />
      <label for="q13-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-3" value="3" <?php echo ($resultado['q13'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-i3" value="3.5" <?php echo ($resultado['q13'] == '3.5')?'checked':'' ?> />
      <label for="q13-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q13" type="radio" id="q13-4" value="4" <?php echo ($resultado['q13'] == '4')?'checked':'' ?> />
  ...
  <div id="q14div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-1" value="1" <?php echo ($resultado['q14'] == '1')?'checked':'' ?> required/>
    ...
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-i1" value="1.5" <?php echo ($resultado['q14'] == '1.5')?'checked':'' ?> />
      <label for="q14-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-2" value="2" <?php echo ($resultado['q14'] == '2')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-i2" value="2.5" <?php echo ($resultado['q14'] == '2.5')?'checked':'' ?> />
      <label for="q14-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-3" value="3" <?php echo ($resultado['q14'] == '3')?'checked':'' ?> />
    ...
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-i3" value="3.5" <?php echo ($resultado['q14'] == '3.5')?'checked':'' ?> />
      <label for="q14-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q14" type="radio" id="q14-4" value="4" <?php echo ($resultado['q14'] == '4')?'checked':'' ?> />
  ...
  <div id="q15div" class="row" style="display:none">
    ...
    <br>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-1" value="1" <?php echo ($resultado['q15'] == '1')?'checked':'' ?> required/>
      <label for="q15-1" class="black-text">A criança não apresentou nenhum sintoma característico de autismo.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-i1" value="1.5" <?php echo ($resultado['q15'] == '1.5')?'checked':'' ?> />
      <label for="q15-i1" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-2" value="2" <?php echo ($resultado['q15'] == '2')?'checked':'' ?> />
      <label for="q15-2" class="black-text">A criança apresentou somente alguns poucos sintomas ou grau leve de autismo.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-i2" value="2.5" <?php echo ($resultado['q15'] == '2.5')?'checked':'' ?> />
      <label for="q15-i2" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-3" value="3" <?php echo ($resultado['q15'] == '3')?'checked':'' ?> />
      <label for="q15-3" class="black-text">A criança apresentou um número de sintomas ou um moderado grau de autismo.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-i3" value="3.5" <?php echo ($resultado['q15'] == '3.5')?'checked':'' ?> />
      <label for="q15-i3" class="black-text">Intermediário.</label>
    </p>
    <p>
      <input class="with-gap" name="q15" type="radio" id="q15-4" value="4" <?php echo ($resultado['q15'] == '4')?'checked':'' ?> />
